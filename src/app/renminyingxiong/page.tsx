...
const RenminYingxiongList = async () => {
  const files = fs.readdirSync(path.join(process.cwd(), 'content', 'renminyingxiong'));
  const pages = files.map((filename) => {
    const filePath = path.join(process.cwd(), 'content', 'renminyingxiong', filename);
...
export default RenminYingxiongList;
